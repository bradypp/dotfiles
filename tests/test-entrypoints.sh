...
for path in packages/install packages/update packages/update-user setup/base/mise setup/base/oh-my-zsh setup/base/plugins setup/wayland/copyq setup/wayland/ydotool setup/kde/klipper setup/storage setup/hardware; do
...
pass 'configure runs base, detected setup directories, machine storage, and hardware'
